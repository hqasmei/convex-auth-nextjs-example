...
import { SignInFormEmailCode } from '@/components/forms/sign-in-form-email-code';
import { SignInFormEmailLink } from '@/components/forms/sign-in-form-email-link';
import { SignInFormPassword } from '@/components/forms/sign-in-form-password';
import { SignInFormPasswordAndResetViaCode } from '@/components/forms/sign-in-form-password-and-reset-via-code';
import { SignInFormPasswordAndVerifyViaCode } from '@/components/forms/sign-in-form-password-and-verify-via-code';
import { Tabs, TabsContent, TabsList, TabsTrigger } from '@/components/ui/tabs';

import { SignInFormPhoneCode } from './forms/sign-in-form-phone-code';
